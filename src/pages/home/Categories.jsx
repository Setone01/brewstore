...
const Categories = () => {
  return (
    <div className="w-screen max-h-max z-10">
      <div className="w-[90%] mx-auto py-10">
        <div className="w-full flex justify-between items-center mb-8">
          <h2 className="text-[1.3rem] text-black font-medium">
            Browse By Category
          </h2>
        ...
        <div className="w-full flex justify-center items-center xs:gap-x-1 md:gap-x-2 flex-wrap">
          <CategoryCard
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
